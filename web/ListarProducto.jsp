            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">
                  ...
                  <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="./Listar?variable=ListarVentas"> <i class='bx bx-folder-plus'></i> Listar Ventas</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="./Listar?variable=ListarVentas2"> <i class='bx bx-folder-plus'></i> Listar Ventas2</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="./Listar?variable=ListarInventario"> <i class='bx bx-folder-plus'></i> Listar Inventarios</a>
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="./Listar?variable=ListarProductos"> <i class='bx bx-file-find'></i>Consulta Productos2</a>
